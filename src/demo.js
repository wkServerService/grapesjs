        ...
        var grapes = new Grapes(
            {
                    ...
                    defaults: [
                        {
                            style: {
                                'width': '100%',
                                'min-height': '550px',
                                'background': 'url("./img/bg-gr-v.png") repeat left top scroll, url("http://www.freewhd.com/wp-content/uploads/2014/01/work-desk-14949.jpg") no-repeat center center scroll'
                            },
                            components: [
                                {
                                    style: {
                                    ...
                                    components: [
                                        ...
                                        },
                                        {
                                            ...
                                            components: [
                                                ...
                                                {
                                                    type: 'text',
                                                    content: 'At the moment uploading of new images is not allowed in demo, so there is only some random images.',
                                                    style: {
                                                        'padding': '7px 7px 7px 7px',
                                                        'min-height': '35px',
                                                        'color': '#444444',
                            ...
                            components: [
                                {
                                    ...
                                    components: [
                                        ...
                                        {
                                            type: 'text',
                                            content: 'Each element of the HTML page could be seen as a block. On the left panel you could find different kind of blocks that you can create, move and style',
                                            style: {
                                                'padding': '7px 7px 7px 7px',
                                                'min-height': '35px',
                                                'color': '#b1b1b1',
                ...
                assetManager: {
                    ...
                    assets: [
                        ...
                        {
                            type: 'image',
                            src: 'http://www.freewhd.com/wp-content/uploads/2014/01/work-desk-14949.jpg',
                            date: '2015-02-01',
                            height: 1080,
                            width: 1728
                        },
                        ...
                        buttons: [{
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    options: {
                                        content: {
                                            style: {width: '100%', 'padding': '7px'},//, 'display': 'table'
                                            components: [
                                                {
                                                    style: {
                                                        width: '50%',
                            ...
                            {
                                id: 'remove',
                                className: 'fa fa-trash-o icon-rm',
                                command: 'delete-comp',
                                attributes: {title: 'Remove element'},
                            },
                            {
                                id: 'move',
